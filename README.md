...
```
> [!NOTE] 
> Change the model name in the path to run the other models and change the CUDA_VISIBLE_DEVICES to the GPU you want to use.
...
> [!NOTE]
> All the additional details about the project are linked in the [Research Project Report](presentations/research_project_report_manpa-final.pdf)
